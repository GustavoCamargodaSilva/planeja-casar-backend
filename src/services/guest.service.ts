...
class GuestService {
  async create(eventId: string, data: CreateGuestInput) {
  ...
  async findAll(eventId: string, filters: GuestFiltersInput = {}) {
  ...
  async update(guestId: string, data: UpdateGuestInput) {
    // Verificar se existe
